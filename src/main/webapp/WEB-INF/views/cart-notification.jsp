		...
		<header class="mdl-layout__header">
			<div class="mdl-layout__header-row">
				<span class="mdl-layout-title">truYum</span> <img
					class="mdl-layout-icon logo" src="images/truyum-logo-light.png" width="16px" height="16px"></img>
						...
						<table class="mdl-data-table mdl-js-data-table">
							...
							<tbody>
								<c:forEach items="${cart}" var="cartItem">
									<tr>
										<td style="text-align: left">${cartItem.item.name}</td>
										<td style="text-align: center">${cartItem.item.freeDelivery}</td>
										<td style="text-align: center">Rs. <fmt:formatNumber
												minFractionDigits="2" value="${cartItem.item.price}"
												type="number" /></td>
										<td><a href="/delete?productId=${cartItem.item.id}">Delete</a></td>
									</tr>
								</c:forEach>
								<tr>
									<td></td>
